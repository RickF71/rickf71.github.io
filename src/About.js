...
export const About = () => {
    return (
        <Container>
            ...
            <Row>
                <h3  style={{overflow:'hidden', display:'inline-block'}}>About Me</h3>
                ...
                <p>
                    I enjoy collaborating on a team and has a great ability to troubleshoot problems. 
                    It's a great thing for me to hear other people's challenges and work together and fix the issues 
                    that might be causing any problems.
                </p>
                <p>
                <ul>
                ...
                <p>I have several years of experience working as a programmer, and have gained expertise 
                in a variety of programming languages and technologies. Some of my notable achievements 
                include teaching part of a Full Stack Developer course and converting a web site from 
                PHP/HTML to an IBM Portal. I'm always looking for new opportunities to learn and grow, 
                and I'm excited to share my knowledge and skills with my readers.</p>

                <h3>Contact Me</h3>

                <p>If you have any questions or would like to get in touch, you can reach me at rickf71@gmail.com or through my LinkedIn profile at https://www.linkedin.com/in/rickfleischman/. I'm always happy to connect with like-minded individuals, so don't be shy!</p>
            </Row>
